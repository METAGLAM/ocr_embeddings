...
```
cd existing_repo
git remote add origin https://ice.eurecat.org/gitlab/big-data/metaglam.git
git branch -M main
...
- [ ] [Set up project integrations](https://ice.eurecat.org/gitlab/big-data/metaglam/-/settings/integrations)
